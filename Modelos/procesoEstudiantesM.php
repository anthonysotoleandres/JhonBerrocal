<?php  //Modelos/procesoEstudiantesM.php
...
class procesoEstudiantesM extends ConexionBD{
    ...
    public function registroEstudiantesM($datosC){
        ...
        $celular = mysql_entities_fix_string($cBD,$tefef);
        ...
        $query = "INSERT INTO $this->tablaBD VALUES 
            (NULL,'$nombre','$apellido',null,'$password','$celular','$genero','$dnii','$email@gmail.com',null,null,'estudiante',null,01)";
